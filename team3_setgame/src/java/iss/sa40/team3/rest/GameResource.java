...
public class GameResource {
    ...
    @GET
    @Path("{gameId}")
    public Response viewGame(@PathParam("gameId") int gameId){
    ...
    @GET
    @Path("{gameId}/{cardId1}/{cardId2}/{cardId3}")
    public Response verifySet(
        ...
        while(!cardBean.setExists(selectedGame.getTable())){
            //return the three cards and add another 3 cards
        }
